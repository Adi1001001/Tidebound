...
public class SlowZoneResizer
{
    [MenuItem("Tools/Convert Slow Zone Sprites To Sliced")]
    static void Convert()
    {
        SlowZone[] slowZones = Object.FindObjectsByType<SlowZone>();

        int converted = 0;

        foreach (SlowZone slowZone in slowZones)
        {
            SpriteRenderer sr = slowZone.GetComponent<SpriteRenderer>();
